           ...
           <div class="col-md-12"> 
             <div class="col-md-offset-1 col-md-4">   
              <div class="form-group @if ($errors->has('placa')) has-error @endif">                
                ...
                <input required="true" type="text" placeholder="VEN027Y" class="form-control" name="placa">
             ...
             <div class="col-md-offset-1 col-md-4">   
              ...
              <div class="form-group @if ($errors->has('marca')) has-error @endif">                
                <label>Marca</label>
                <input required="true" type="text" placeholder="Ferrari" class="form-control" name="marca">
             ...
             <div class="col-md-offset-1 col-md-4">  
              <div class="form-group @if ($errors->has('modelo')) has-error @endif">                
                <label>Modelo</label>
                <input required="true" type="text" placeholder="570T" class="form-control" name="modelo">
             ...
             <div class="col-md-offset-1 col-md-4">  
              <div class="form-group @if ($errors->has('anio')) has-error @endif">                
                <label>Año</label>
                <input required="true" type="text" placeholder="2015" class="form-control" name="anio">
             ...
             <div class="col-md-offset-1 col-md-4">  
              <div class="form-group @if ($errors->has('serial_motor')) has-error @endif">                
                ...
                <input required="true" type="text" placeholder="538H37893692N" class="form-control" name="serial_motor">
             ...
             <div class="col-md-offset-1 col-md-4">  
              ...
              <div class="form-group @if ($errors->has('serial_carro')) has-error @endif">                
                ...
                <input required="true" type="text" placeholder="89298M2FYN" class="form-control" name="serial_carro">
             ...
             <div class="col-md-offset-1 col-md-4">            
              <div class="form-group @if ($errors->has('color')) has-error @endif">                
                <label>Color</label>
                <input required="true" type="text" placeholder="Negro" class="form-control" name="color">
             ...
             <div class="col-md-offset-1 col-md-4">     
              <div class="form-group @if ($errors->has('propietario')) has-error @endif">                
                ...
                <input required="true" type="text" placeholder="Osward" class="form-control" name="propietario">
